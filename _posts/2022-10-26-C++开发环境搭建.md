...
- 国内服务器访问github难的问题
    ...
    - git push时遇到以下问题，多提交几次就好
        - fatal: unable to access '****.git/': Failed to connect to github.com port 443: Timed out
        - fatal: unable to access '****.git/': Empty reply from server
        - fatal: unable to access '****.git/': Encountered end of file
    - 其它
        + private仓库是不能clone的
