...
## 伪随机数
https://blog.csdn.net/liyuanbhu/article/details/70477408
- 头文件：random.h
- 随机数引擎：用来产生均匀分布随机数
    - linear_congruential_engine
        - 线性同余法，运算速度较快，是使用最广泛的随机数引擎
        - 大多数时候，只要直接使用 minstd_rand0 或 minstd_rand 就可以了
...
## 花花酱
https://www.youtube.com/watch?v=7kdeb2aAGJA&list=PLLuMmzMTgVK7XfFadhkPuF_ztvhxbriDr&index=5&ab_channel=HuaHua
