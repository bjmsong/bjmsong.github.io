...
### vim, emacs
- https://www.bilibili.com/video/BV1Y741137up/?spm_id_from=333.999.0.0&vd_source=7798c62f92ce545f56fd00d4daf55e26
    - 命令模式，输入模式，底线命令模式
        - 常用命令
    - 配置文件
    - vimtutor
...
- 机器配置
    ...
    + 8G内存
- 常用命令
    git remote set-url origin https://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@github.com/bjmsong/bjmsong.github.io.git
    scp root@121.4.98.108:/root/project/pytorch_in_action/onnx/amplify_dynamic/srcnn2.onnx .
    scp local_file root@121.4.98.108:/root/project/cpp_practise/opencv_test/
    + htop
        * 交互式的进程查看器
