...
- https://fengberlin.github.io/post/%E5%BF%AB%E9%80%9F%E6%8E%92%E5%BA%8F%E5%92%8C%E5%AE%83%E5%9C%A8%E5%B7%A5%E7%A8%8B%E5%AE%9E%E8%B7%B5%E4%B8%AD%E7%9A%84%E5%BA%94%E7%94%A8/
...
- **二叉堆**
    - 一组能够用堆有序的**完全二叉树**排序的元素，并在数组中按层级存储（不使用数组的第一个元素）   
        ...
        - 一棵大小为Ｎ的完全二叉树的高度为lgN
- **优先队列的应用：top K问题**
    - 实际应用中常见的是大数据和数据流（如leetcode 703）的问题：每次得到一个新的数据，返回当前数据流中第k大元素。
        - 如果用排序的方法，每次得到新数据后，要重新排序，快排的话是nlogn时间复杂度，当n很大时，时间开销很大
        - 用堆的方法，只需要维护一个大小为k的堆即可，时间复杂度是logk，效率高很多
- 堆排序
    - 堆的构造
        - 从右至左用sink()函数构造子堆
    - 下沉排序 
...
- https://juejin.im/post/5c0b75fef265da6115109d35
